...
public class MyGameStateTest2 {
    ...
    public static final List<Tile> TILES = ch.epfl.chacun.tile.Tiles.TILES;
    ...
    public static TileDecks initialTileDecks2 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.getFirst(), TILES.get(83), TILES.get(13), TILES.get(17), TILES.get(4)),
            List.of(TILES.get(79)));
    ...
    public static TileDecks initialTileDecks3 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.get(19), TILES.getFirst(), TILES.get(24)),
            List.of(TILES.get(79)));
    ...
    public static TileDecks initialTileDecks4 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.getFirst(), TILES.get(1), TILES.get(17)),
            List.of(TILES.get(79)));
    ...
    public static TileDecks initialTileDecks5 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.get(1), TILES.get(61), TILES.getFirst()),
            List.of(TILES.get(79)));
    ...
    public static TileDecks initialTileDecks6 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.get(49), TILES.get(27), TILES.get(62), TILES.get(61),TILES.get(1),TILES.getFirst(),TILES.get(8)),
    ...
    public static TileDecks initialTileDecks7 = new TileDecks(
            List.of(TILES.get(56)),
            List.of(TILES.get(49), TILES.get(27),TILES.get(1),TILES.getFirst(),TILES.get(8)),
    ...
    void freeOccupantsCountWorks(){
        ...
        assertEquals(4, gameState5.freeOccupantsCount(PlayerColor.RED, Occupant.Kind.PAWN));
        ...
        assertEquals(3, gameState5.freeOccupantsCount(PlayerColor.RED, Occupant.Kind.HUT));
