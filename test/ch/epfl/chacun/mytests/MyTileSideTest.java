...
class MyTileSideTest {
    @Test
    void sameSide(){
        Assertions.assertTrue(new TileSide.Forest(new Zone.Forest(0, Zone.Forest.Kind.PLAIN)).isSameKindAs(new TileSide.Forest(new Zone.Forest(1, Zone.Forest.Kind.PLAIN))));
